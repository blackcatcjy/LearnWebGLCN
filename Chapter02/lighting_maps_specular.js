...
function draw(gl ,canvas ,n,currentAngle, colorProgram , lampProgram){
    ...
    // gl.uniform3f(u_LightAmbient, 1, 1, 1);
    // console.log("1111");
    ...
    // gl.uniform3f(u_LightDiffuse, 0.2, 0.2, 0.2);
    ...
    gl.uniform3f(u_LightPosition, 1.2, 1.0, 2.0);
    ...
    //material properties
    // var u_MaterialAmbient = gl.getUniformLocation(gl.program, "u_Material.ambient");
    // gl.uniform3f(u_MaterialAmbient, 1.0, 0.5, 0.31);

    // var u_MaterialDiffuse = gl.getUniformLocation(gl.program, "u_Material.diffuse");
    // gl.uniform3f(u_MaterialDiffuse, 1.0, 0.5, 0.31);
  
    // var u_MaterialSpecular = gl.getUniformLocation(gl.program, "u_Material.specular");
    // gl.uniform3f(u_MaterialDiffuse, 0.5, 0.5, 0.5);
